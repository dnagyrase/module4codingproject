Code book for Coursera Getting and Cleaning Data Module 4 Coding Project

The data set that this code book is associated to is located in the tidy_data.txt file of this Github repository.

Refer to README.md file of this repository for background information on this data set.

Refer to Data section below for overview of structure of this data set.

Refer to Variables section below for variables list.

Refer to Transformations section below for the transformations that were carried out on data. 
...
Prior to normalisation, acceleration measurements (variables containing Accelerometer) were made in g's (9.81 m.s⁻²) and gyroscope measurements (variables containing Gyroscope) were made in radians per second (rad.s⁻¹).  Refer to UCI HAR website.
